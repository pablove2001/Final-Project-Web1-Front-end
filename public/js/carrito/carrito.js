...
axios
  .get("https://cleorganic.herokuapp.com/account", { headers: data })
  .then((response) => {})
  .catch((err) => {
    window.location = "log-in.html";
  });
...
axios
  .get("https://cleorganic.herokuapp.com/carrito", { headers: data })
  .then((response) => {
    console.log(response);
    var elementos = "";
    response.map((item) => {
      axios
        .get("https://cleorganic.herokuapp.com/productos/" + item.id_producto)
        .then((producto) => {
...
buttoneliminar.addEventListener("click", () => {
  ...
  axios
    .delete("https://cleorganic.herokuapp.com/carrito/all", { headers: data })
    .then((respuesta) => {
